...
> {
  ...
  constructor(
    @inject('datasources.postgres') dataSource: PostgresDataSource, @repository.getter('MeterRepository') protected meterRepositoryGetter: Getter<MeterRepository>,
  ) {
    super(Value, dataSource);
    this.meter = this.createBelongsToAccessorFor('meter', meterRepositoryGetter,);
